...
ShrubberyCreationForm::ShrubberyCreationForm() : AForm("Shrubbery Creation Form", 145, 137), _target("default") {
	...
	std::cout << "\033[90mShrubberyCreationForm constructor called.\033[0m" << std::endl;
}
...
ShrubberyCreationForm::ShrubberyCreationForm(const ShrubberyCreationForm& to_copy) : AForm(to_copy), _target(to_copy._target) {
	std::cout << "\033[90mShrubberyCreationForm copy constructor called.\033[0m" << std::endl;
}

//COPY ASSIGNMENT
ShrubberyCreationForm& ShrubberyCreationForm::operator=(const ShrubberyCreationForm& to_copy) {
	std::cout << "\033[90mShrubberyCreationForm copy assignment operator called.\033[0m" << std::endl;
	if (this != &to_copy)
	{
...
ShrubberyCreationForm::~ShrubberyCreationForm() {
	std::cout << "\033[90mShrubberyCreationForm destructor called.\033[0m" << std::endl;
}
