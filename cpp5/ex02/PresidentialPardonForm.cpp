...
PresidentialPardonForm::PresidentialPardonForm() : AForm("Presidential Pardon Form", 25, 5), _target("default") {
	...
	std::cout << "\033[90mPresidentialPardonForm constructor called.\033[0m" << std::endl;
}
...
PresidentialPardonForm::PresidentialPardonForm(const PresidentialPardonForm& to_copy) : AForm(to_copy), _target(to_copy._target) {
	std::cout << "\033[90mPresidentialPardonForm copy constructor called.\033[0m" << std::endl;
}

//COPY ASSIGNMENT
PresidentialPardonForm& PresidentialPardonForm::operator=(const PresidentialPardonForm& to_copy) {
	std::cout << "\033[90mPresidentialPardonForm copy assignment operator called.\033[0m" << std::endl;
	if (this != &to_copy)
	{
...
PresidentialPardonForm::~PresidentialPardonForm() {
	std::cout << "\033[90mPresidentialPardonForm destructor called.\033[0m" << std::endl;
}
