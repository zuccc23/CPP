...
RobotomyRequestForm::RobotomyRequestForm()  : AForm("Robotomy Creation Form", 72, 45), _target("default") {
	std::cout << "\033[90m✿RobotomyRequestForm constructor called✿\033[0m" << std::endl;
}
...
RobotomyRequestForm::RobotomyRequestForm(const RobotomyRequestForm& to_copy) : AForm(to_copy), _target(to_copy._target)  {
	std::cout << "\033[90m✿RobotomyRequestForm copy constructor called✿\033[0m" << std::endl;
}

//COPY ASSIGNMENT
RobotomyRequestForm& RobotomyRequestForm::operator=(const RobotomyRequestForm& to_copy) {
	std::cout << "\033[90m✿RobotomyRequestForm copy assignment operator called✿\033[0m" << std::endl;
	if (this != &to_copy)
	{
...
RobotomyRequestForm::~RobotomyRequestForm() {
	std::cout << "\033[90m~RobotomyRequestForm destructor called.\033[0m" << std::endl;
}
