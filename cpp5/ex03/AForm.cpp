...
std::ostream &operator<<(std::ostream &output_stream, const AForm &form)
{
	if (form.getSign() == true)
		output_stream << form.getName() << " is signed. It requires a grade of " << form.getGradeToSign() << " to be signed, and a grade of " << form.getGradeToExecute() << " to be executed." << std::endl;
	else if (form.getSign() == false)
		output_stream << form.getName() << " is not signed. It requires a grade of " << form.getGradeToSign() << " to be signed, and a grade of " << form.getGradeToExecute() << " to be executed." << std::endl;
